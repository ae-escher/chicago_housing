...
Adding redlining data and zipcodes
```{r}
chicago_purchases <- chicago_purchases %>%
...
Creating dataframe for statstistical analysis by census tract. 
```{r}
...
## Creating redlining ranking for 2012-2018 census tracts  
```{r}
nrow(census_stats)
...
stargazer(ols_cont_reg, ols_categ_reg,
         ...
         font.size = "small",
         column.labels = c("Total home loan amount by Census Tract"),
...
stargazer(grade_cont_reg, grade_categ_reg,
         ...
         column.sep.width = "3pt", # to reduce column width
         font.size = "small",
         covariate.labels = c("Grade 3", "Grade 4" ))

stargazer(cat_2, cat_3, cat_4, co)
